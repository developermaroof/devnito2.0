...
const Services = () => {
  return (
    <div className='Services bg-darker-theme gap-5 py-16 p-6 justify-center flex flex-col text-center items-center'>
      <p className='text-xs font-thin font-josefin'>NOT TO MENTION
      </p>
      <h1 className='font-bold text-xl font-josefin'>Our Services</h1>
