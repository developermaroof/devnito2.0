...
const WhyChoose = () => {
  return (
    <div className='WhyChoose bg-darker-theme gap-4 py-16 p-6 justify-center flex flex-col text-center items-center'>
      <p className='text-xs font-thin font-josefin'>AND LET'S NOT FORGET
      </p>
      <h1 className='font-bold text-2xl font-josefin'>Why Choose DevNito</h1>
