...
const Team = () => {
  return (
    <div className='Team flex flex-col items-center text-center'>
        ...
        <div className='bg-darker-theme pb-10 px-10 flex flex-col gap-28'>
            <h1 className='bg-dark-theme text-md font-josefin px-5 py-6 rounded-b-2xl'>Meet the best team ever</h1>
        <div className='teamMember flex flex-col  gap-28'>
