...
const Team = () => {
  return (
    <div className='Team flex flex-col items-center text-center'>
        <div className='bg-dark-theme py-8 px-10 sm:px-20'>
            <img src={teamImg} alt="" />
        </div>

        <div className='bg-darker-theme pb-10 px-10 sm:px-32 md:px-40 flex flex-col gap-28 md:gap-52'>
            <h1 className='bg-dark-theme text-md md:text-xl font-josefin px-5 md:px-10 py-6 rounded-b-2xl'>Meet the best team ever</h1>
        <div className='teamMember flex flex-col  gap-28 md:gap-52'>
        <div className='member1 bg-dark-theme px-6 pb-6 pt-20 relative '>
        <div className='absolute -top-36 left-1/2 transform -translate-x-1/2  rounded-xl p-2 w-44 md:w-60'>
            <img src={junaid} alt="" />
        </div>
