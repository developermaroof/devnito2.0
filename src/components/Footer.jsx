  ...
  return (
    ...
    <div className='2xl:max-w-screen-2xl 2xl:mx-auto flex flex-col py-4 justify-center items-center text-center gap-3 sm:gap-2'>
      ...
      <div className='socials flex gap-3'>
        <a> <img className='w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7' src={Facebook} alt="" /></a>
        <a> <img className='w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7' src={Linkedin} alt="" /></a>
        <a> <img className='w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7' src={Email} alt=""    /></a>
      </div>
    </div>
    </div>
